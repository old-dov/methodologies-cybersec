...
**Flag :** `FLAG_1{PROFILE_GLITCH_EXPOSED}`
...
**Flag :** `FLAG_3{TIME_TRAVELER_FOUND_THE_LOG}`
...
**Flag :** `FLAG_4{HIDDEN_POST_PARAM_FOUND}`
...
**Flag :** `FLAG_5{HPP_DOUBLE_PARAMETER_MASTERY}`
...
**Flag :** `FLAG_6{BASE64_IS_NOT_ENCRYPTION}`
...
**Flag :** `FLAG_7{HTTP_VERB_TAMPERING_MASTER}`
...
**Flag :** `FLAG_8{BLIND_PROMOTION_SUCCESSFUL}`
...
**Flag :** `FLAG_9{GOD_MODE_IDOR_VIA_HEADERS_COMPLETE}`
...
**Flag :** `FLAG_10{SSRF_INTERNAL_PORT_AND_AUTH_BYPASS}`
...
**Flag :** `FLAG_11{GOPHER_PROTOCOL_HEADER_FORGERY}`
...
**Flag :** `BONUS{Y0U_4R3_B31NG_W4TCH3D}`
