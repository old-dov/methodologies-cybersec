...
Attaques, protocoles de routage/commutation et déploiement d'infrastructure réseau.

- [ARP Spoofing (Man-in-the-Middle)](reseau/arp-spoofing-mitm.md)
- [Routage Dynamique OSPF](reseau/ospf-routage-dynamique.md)
- [VLAN, Trunking et STP](reseau/vlan-trunking-stp.md)
